#!/usr/bin/env python
# pharos server module which watches output photometry files
# and broadcasts new data as it arrives over TCP/IP using ZeroMQ

# Usage:
# pharos_server_module.py [port] [obsid] [band] [targetfile] [tsleep] 
...
parser = argparse.ArgumentParser(description='pharos live data broadcasting module')
  ...
  while True:
      ...
      if datafiletime != lastdatafiletime:
          ...
          if firsttime:
              ...
              print "pharos: the input file has", filelen, " existing lines"
              nline = filelen
